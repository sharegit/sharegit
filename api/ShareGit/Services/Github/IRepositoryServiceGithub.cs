...
namespace ShareGit
{
    public interface IRepositoryServiceGithub
    {
        ...
        Task<APIResponse<PaginatedGithubResponse<GithubRepository>>> GetRepositoriesAccessibleToUserInstallation(int installationId, GithubUserAccess userAccess);
        Task<APIResponse<PaginatedGithubResponse<GithubRepository>>> GetInstallationRepositories(GithubAppAccess installationAccess);
        ...
        Task<APIResponse<PaginatedGithubResponse<GithubUserInstallation>>> GetUserInstallations(GithubUserAccess userAccessToken);
